...
export const recipes: RecipeMeta[] = [
  ...
  {
    slug: 'dryRubs',
    title: 'From-Scratch Dry Rubs',
    category: 'condiments',
    description: '7 regional dry rubs \u2014 Texas brisket, Kansas City rib, Carolina pork, Alabama chicken, coffee cowboy, lemon-pepper, and all-purpose sweet heat.',
    cookTemp: 'N/A',
    cookTime: '5 min each',
    ingredients: [
      {
        groupName: 'Texas Brisket Rub',
        items: [
          { name: 'Coarse kosher salt', amount: '1/4 cup', shoppingCategory: 'spice' },
          { name: 'Coarse black pepper (16-mesh)', amount: '1/4 cup', shoppingCategory: 'spice' },
          { name: 'Garlic powder', amount: '1 tbsp', optional: true, shoppingCategory: 'spice' },
          { name: 'Smoked or sweet paprika', amount: '1 tbsp', optional: true, shoppingCategory: 'spice' },
        ],
      },
      {
        groupName: 'Kansas City Rib Rub',
        items: [
          { name: 'Brown sugar', amount: '1/2 cup', shoppingCategory: 'pantry' },
          { name: 'Paprika', amount: '1/4 cup', shoppingCategory: 'spice' },
          { name: 'Black pepper', amount: '1 tbsp', shoppingCategory: 'spice' },
          { name: 'Kosher salt', amount: '1 tbsp', shoppingCategory: 'spice' },
          { name: 'Chili powder', amount: '1 tbsp', shoppingCategory: 'spice' },
          { name: 'Garlic powder', amount: '1 tbsp', shoppingCategory: 'spice' },
          { name: 'Onion powder', amount: '1 tbsp', shoppingCategory: 'spice' },
          { name: 'Cayenne pepper', amount: '1 tsp', shoppingCategory: 'spice' },
        ],
      },
      {
        groupName: 'Carolina Pork Rub',
        items: [
          { name: 'Paprika', amount: '1/4 cup', shoppingCategory: 'spice' },
          { name: 'Brown sugar', amount: '1/4 cup', shoppingCategory: 'pantry' },
          { name: 'Kosher salt', amount: '2 tbsp', shoppingCategory: 'spice' },
          { name: 'Chili powder', amount: '1 tbsp', shoppingCategory: 'spice' },
          { name: 'Cayenne', amount: '1 tsp', shoppingCategory: 'spice' },
          { name: 'Dried oregano', amount: '1 tsp', shoppingCategory: 'spice' },
          { name: 'Dried thyme', amount: '1 tsp', shoppingCategory: 'spice' },
          { name: 'Ground cumin', amount: '1 tsp', shoppingCategory: 'spice' },
      ...
      {
        groupName: 'Alabama Chicken Rub',
        items: [
          { name: 'Brown sugar', amount: '1/4 cup', shoppingCategory: 'pantry' },
          { name: 'Black pepper', amount: '1 tbsp', shoppingCategory: 'spice' },
          { name: 'Kosher salt', amount: '2 tsp', shoppingCategory: 'spice' },
          { name: 'Smoked paprika', amount: '2 tsp', shoppingCategory: 'spice' },
          { name: 'Garlic powder', amount: '1 tsp', shoppingCategory: 'spice' },
          { name: 'Onion powder', amount: '1 tsp', shoppingCategory: 'spice' },
          { name: 'Ground mustard', amount: '1 tsp', shoppingCategory: 'spice' },
          { name: 'Cayenne pepper', amount: '1/4 tsp', shoppingCategory: 'spice' },
        ],
      },
      {
        groupName: 'Coffee Cowboy Rub',
        items: [
          { name: 'Finely ground dark-roast coffee', amount: '2 tbsp', shoppingCategory: 'pantry' },
          { name: 'Brown sugar', amount: '2 tbsp', shoppingCategory: 'pantry' },
          { name: 'Coarse kosher salt', amount: '1 tbsp', shoppingCategory: 'spice' },
          { name: 'Chili powder', amount: '1 tbsp', shoppingCategory: 'spice' },
          { name: 'Paprika', amount: '1/2 tbsp', shoppingCategory: 'spice' },
          { name: 'Black pepper', amount: '1/2 tbsp', shoppingCategory: 'spice' },
          { name: 'Onion powder', amount: '1/2 tbsp', shoppingCategory: 'spice' },
          { name: 'Garlic powder', amount: '1/2 tbsp', shoppingCategory: 'spice' },
          { name: 'Cayenne', amount: '1/2 tsp', shoppingCategory: 'spice' },
          { name: 'Unsweetened cocoa powder', amount: '1/2 tsp', optional: true, shoppingCategory: 'pantry' },
        ],
      },
      {
        groupName: 'Lemon-Pepper Chicken Rub',
        items: [
          { name: 'Coarse black pepper', amount: '4 tbsp', shoppingCategory: 'spice' },
          { name: 'Dried lemon peel granules', amount: '3 tbsp', shoppingCategory: 'spice' },
          { name: 'Kosher salt', amount: '2 tbsp', shoppingCategory: 'spice' },
          { name: 'Granulated garlic', amount: '1 tbsp', shoppingCategory: 'spice' },
          { name: 'Citric acid', amount: '1/4 tsp', optional: true, shoppingCategory: 'pantry' },
        ],
      },
      {
        groupName: 'All-Purpose Sweet Heat Rub',
        items: [
          { name: 'Brown sugar', amount: '1/4 cup', shoppingCategory: 'pantry' },
          { name: 'Kosher salt', amount: '2 tbsp', shoppingCategory: 'spice' },
          { name: 'Paprika', amount: '2 tbsp', shoppingCategory: 'spice' },
          { name: 'Black pepper', amount: '1 tbsp', shoppingCategory: 'spice' },
          { name: 'Garlic powder', amount: '1 tbsp', shoppingCategory: 'spice' },
          { name: 'Onion powder', amount: '1 tbsp', shoppingCategory: 'spice' },
          { name: 'Ground mustard', amount: '1 tsp', shoppingCategory: 'spice' },
